...
class Embeddings(nn.Module):
    ...
    def __init__(self, vocab_size: int, dim_model: int) -> None:
        ...
        :type vocab_size: int
        :param dim_model: the dimension of a vector that will contain the feature that represent a word
        :type dim_model: int
        """
    ...
    def forward(self, inputs: torch.Tensor) -> torch.Tensor:
        """Pass a tensors to the embedding layer

        :param inputs: the inputs that contains the words of shape (batch_size, max_seq_length)
